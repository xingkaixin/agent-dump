...
An experimental Rust implementation is being developed in [`rust/`](rust/README.md). It currently supports Codex discovery, transcript assembly, and print/JSON/Markdown/raw export; pip/npm still install the Python implementation. See the [migration plan](docs/rust-migration-plan.md) for scope and acceptance criteria.
