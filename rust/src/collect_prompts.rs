...
fn text(mode: Mode, stage: &str) -> &'static str {
    match (mode, stage) {
        (Mode::Pm, "chunk") => include_str!("../prompts/pm-chunk.txt"),
        (Mode::Insight, "chunk") => include_str!("../prompts/insight-chunk.txt"),
        (Mode::Pm, "report") => include_str!("../prompts/pm-report.txt"),
        (Mode::Insight, "report") => include_str!("../prompts/insight-report.txt"),
        (Mode::Pm, "merge") => include_str!("../prompts/pm-merge.txt"),
        (Mode::Insight, "merge") => include_str!("../prompts/insight-merge.txt"),
        (Mode::Pm, "retry") => include_str!("../prompts/pm-retry.txt"),
        (Mode::Insight, "retry") => include_str!("../prompts/insight-retry.txt"),
        (Mode::Pm, "handoff") => include_str!("../prompts/pm-handoff.txt"),
        (Mode::Insight, "handoff") => include_str!("../prompts/insight-handoff.txt"),
        _ => unreachable!(),
    }
}
