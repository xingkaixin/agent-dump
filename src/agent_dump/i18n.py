...
TRANSLATIONS = {
    "en": {
        ...
        Keys.CLI_URI_HELP: "Agent session URI to dump, or agents://<path>?q=<keyword>&providers=<names> for scoped queries",
        ...
        Keys.CLI_QUERY_HELP: "Query filter, supports 'agent1,agent2:keyword' or 'keyword'; cannot be combined with agents:// query URIs",
    ...
    "zh": {
        ...
        Keys.CLI_URI_HELP: "要导出的 Agent 会话 URI，或使用 agents://<path>?q=<关键词>&providers=<名称> 做路径作用域查询",
        ...
        Keys.CLI_QUERY_HELP: "查询过滤器，支持 'agent1,agent2:关键词' 或 '关键词'；不能与 agents:// 查询 URI 同时使用",
