...
EN_TRANSLATIONS = {
    ...
    Keys.COLLECT_DISCOVERY_INCOMPLETE_REPORT: "Warning: This report is incomplete. Discovery failed for {count} providers; the number of omitted sessions is unknown.",
    ...
    Keys.DIAG_URI_CAPABILITY_GAP: "The current request uses an export capability {agent} does not support.",
    Keys.DIAG_URI_CAPABILITY_DETAIL: "{agent} supports only {supported}; requested {requested}",
