...
# Translation keys
class Keys:
    DIAG_MINIMAX_SOURCE_MISSING = "DIAG_MINIMAX_SOURCE_MISSING"
    DIAG_MINIMAX_SCHEMA = "DIAG_MINIMAX_SCHEMA"
    DIAG_MINIMAX_CURRENT_DATABASE_ONLY = "DIAG_MINIMAX_CURRENT_DATABASE_ONLY"
    DIAG_MINIMAX_MIGRATION_REQUIRED = "DIAG_MINIMAX_MIGRATION_REQUIRED"
    WARN_MINIMAX_SESSION_READ_FAILED = "WARN_MINIMAX_SESSION_READ_FAILED"
    DIAG_CHERRY_SOURCE_MISSING = "DIAG_CHERRY_SOURCE_MISSING"
    DIAG_CHERRY_SCHEMA = "DIAG_CHERRY_SCHEMA"
    DIAG_CHERRY_CURRENT_DATABASE_ONLY = "DIAG_CHERRY_CURRENT_DATABASE_ONLY"
    WARN_CHERRY_SESSION_READ_FAILED = "WARN_CHERRY_SESSION_READ_FAILED"
    DIAG_DEEPCHAT_SOURCE_MISSING = "DIAG_DEEPCHAT_SOURCE_MISSING"
    DIAG_DEEPCHAT_UNREADABLE = "DIAG_DEEPCHAT_UNREADABLE"
    DIAG_DEEPCHAT_PLAIN_DATABASE_ONLY = "DIAG_DEEPCHAT_PLAIN_DATABASE_ONLY"
    DIAG_DEEPCHAT_SCHEMA = "DIAG_DEEPCHAT_SCHEMA"
    DIAG_DEEPCHAT_CURRENT_DATABASE_ONLY = "DIAG_DEEPCHAT_CURRENT_DATABASE_ONLY"
    ...
    CLI_EMIT_PROMPT_HELP = "CLI_EMIT_PROMPT_HELP"
    ...
    EMIT_PROMPT_REQUIRES_COLLECT = "EMIT_PROMPT_REQUIRES_COLLECT"
    COLLECT_ACTION_CONFLICT = "COLLECT_ACTION_CONFLICT"
    ...
    COLLECT_DISCOVERY_INCOMPLETE_REPORT = "COLLECT_DISCOVERY_INCOMPLETE_REPORT"
    COLLECT_INCOMPLETE_REPORT = "COLLECT_INCOMPLETE_REPORT"
